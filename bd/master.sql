...
-- -----------------------------------------------------------------------------
-- 8. TABELA DE GRUPOS DE WHATSAPP
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 9. TABELAS DA CENTRAL DE TRABALHO (JOBS & FILA)
-- -----------------------------------------------------------------------------
...
INSERT INTO `system_jobs` (`job_key`, `name`, `description`, `is_active`, `min_delay_seconds`, `max_delay_seconds`, `created_at`, `updated_at`)
VALUES (
